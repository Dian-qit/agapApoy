...
template <> constexpr inline auto dashboard::qt_create_metaobjectdata<qt_meta_tag_ZN9dashboardE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "dashboard",
        "on_dashboardPushButton_2_clicked",
        "",
        "on_tablePushButton_clicked",
        "on_dashboardPushButton_3_clicked",
        "on_tablePushButton_3_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_dashboardPushButton_2_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_tablePushButton_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_dashboardPushButton_3_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_tablePushButton_3_clicked'
...
void dashboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_dashboardPushButton_2_clicked(); break;
        case 1: _t->on_tablePushButton_clicked(); break;
        case 2: _t->on_dashboardPushButton_3_clicked(); break;
        case 3: _t->on_tablePushButton_3_clicked(); break;
        default: ;
        }
    }
    (void)_a;
